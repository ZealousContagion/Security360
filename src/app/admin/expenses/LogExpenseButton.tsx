...
export function LogExpenseButton() {
    ...
    return (
        <>
            <Button onClick={() => setIsOpen(true)} className="text-[10px] uppercase tracking-[0.2em] font-bold h-10 px-6">
                        ...
                        <CardContent>
                            <form action={handleSubmit} className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <Input name="description" placeholder="e.g. Fuel for Van 1" required />
                                </div>
