    ...
    return (
        <div className="max-w-2xl mx-auto space-y-8">
            <div>
                ...
                <h1 className="text-3xl font-black tracking-tighter uppercase">Edit Member</h1>
                <p className="text-muted-foreground uppercase text-[10px] tracking-widest font-bold mt-1">Update profile and availability</p>
            </div>

            <TeamMemberForm member={member} action={updateAction} />
        </div>
    );
}
